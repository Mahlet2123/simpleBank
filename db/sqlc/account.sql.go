...
func (q *Queries) GetAccount(ctx context.Context, limit int32) (Account, error) {
	row := q.db.QueryRow(ctx, getAccount, limit)
	var i Account
	err := row.Scan(
		&i.ID,
		&i.Owner,
...
func (q *Queries) GetAccountForUpdate(ctx context.Context, limit int32) (Account, error) {
	row := q.db.QueryRow(ctx, getAccountForUpdate, limit)
	var i Account
	err := row.Scan(
		&i.ID,
		&i.Owner,
